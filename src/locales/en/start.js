export default {
  ...
  projectInfo: {
    ...
    map: {
      ...
      section2: "Coordinate1 (Latitude, Longitude)",
      section3: "Coordinate2 (Latitude, Longitude)",
      section4: "Coordinate3 (Latitude, Longitude)",
      section5: "Coordinate4 (Latitude, Longitude)",
      text: " ※ Please enter the coordinates of four points in the area corresponding to the study scope. The picture below is an example.",
    },
    nextButton: "Next",
    alert: {
      alert1: "Insert Project title.",
      alert2: "Insert Project manager.",
      alert3: "Insert Project date/time.",
      alert4: "Select Risk assessment type.",
      alert5: "Insert data size. (row)",
      alert6: "Insert data size. (column)",
      alert7: "Insert Latitude.",
      alert8: "Insert Longitude.",
    },
  },
  typeInfo: {
